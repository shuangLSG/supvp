        ...
        <div class="mui-scroll-wrapper mui-content bg-white">
            <div class="mui-scroll ">
                <section class="limit-hd page-section-60">
                    <h2 class="text-size-25 font-black">社保认证</h2>
                ...
                <section class="limit-bd margin-h-10 page-section-46">
                    <form class="mui-input-group">
                        <div id="link-areaSelect" class="mui-input-row text-size-15">
                            <label class="font-black">缴纳社保所在城市</label>
                        ...
                        <div class="mui-input-row text-size-15">
                            <label class="font-black">社保查询账户</label>
                            <input id="account" type="text" placeholder="请输入社保查询账户">
                        </div>
                        <div class="mui-input-row text-size-15">
                            <label class="font-black">社保查询密码</label>
                            <input id="password" type="text" placeholder="请输入社保查询密码">
                        </div>
                    </form>
                </section>
            ...
            $(function () {
                ...
                (function (mui, $) {
                    ...
                    function addProfession(){
                        ...
                        $.post('../user/addSocialSecurity',json, function (res) {
                            if (res.s == 200) {
