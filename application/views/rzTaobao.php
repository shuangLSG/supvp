        ...
        <div class="mui-scroll-wrapper mui-content bg-white">
            <div class="mui-scroll page-section-60">
                <section class="limit-hd">
                    <h2 class="text-size-25 font-black">淘宝认证</h2>
                ...
                <section class="limit-bd margin-h-10">
                    <form class="mui-input-group">
                        <div class="mui-input-row text-size-15">
                            <label class="font-black">淘宝账户</label>
                            <input id="account" type="text" placeholder="请输入淘宝账户">
                        </div>
                        <div class="mui-input-row text-size-15">
                            <label class="font-black">淘宝密码</label>
                            <input id="password" type="text" placeholder="请输入淘宝密码">
                        </div>
                    </form>
            ...
            $(function () {
                ...
                (function (mui, $) {
                    ...
                    function addProfession() {
                        ...
                        $.post('../user/addTaobao', json, function (res) {
                            if (res.s == 200) {
