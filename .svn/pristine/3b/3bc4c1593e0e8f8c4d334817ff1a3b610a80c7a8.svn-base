    ...
    (function (mui, $) {
            ...
            setTimeout(function () {
                $.post('../collection/getCollection', {
                    ...
                    if (data.s == 200) {
                        ...
                        if (data.Collectiondata == null || data.Collectiondata.length == 0 || data.Collectiondata.length < data.PageSize) { // 获取到第3页的数据就结束上拉操作
                            flage = false;
                        ...
                        if ((data.Collectiondata == null || data.Collectiondata.length == 0)&& pageNum==1) {
                            $('.page-nodata').show();
                        }
        ...
        var tools = {
            ...
            deleteAll: function (id) {
                $.post('../collection/deleteCollectionAll', {
                    "id": id
                }, function (res) {
                    if (res.s == 200) {
